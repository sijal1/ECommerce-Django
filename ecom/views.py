...
def home_view(request):
    ...
    return render(request,'ecom/index.html',{'products':products,'categories': categories,'product_count_in_cart':product_count_in_cart})
    
def category_view(request, category_id):
    category = Category.objects.get(id=category_id)
    products = Product.objects.filter(category=category)
    return render(request, 'ecom/category_view.html', {'category': category, 'products': products})
